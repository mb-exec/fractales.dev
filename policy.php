...
<section class="policy text-ls sect">
  <div class="container">
    <h1>Privacy Policy</h1>
    <p>Your privacy is important to us. It is fractales&#39; policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="<?php echo $site_url ?>">www.fractales.dev</a>, and other sites we own and operate. </p>
    <p>This policy was last updated on 31 May 2022. </p>
    ...
    <h4 id="information">Personal Information</h4>
    ...
    <p>
      phone number: <br><a href="tel:<?php echo $tel_link ?>"><?php echo $tel ?></a>
      <br><br>
      email: <br><a href="mail:<?php echo $email ?>"><?php echo $email ?></a>
    </p>
  </div>
</section>
