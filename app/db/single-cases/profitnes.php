<?php
  $profitnes = [
    ...
    // секция about
    'about' => 'ProFitnessLife is a weekly healthy body course. Target audience – girls and women who want to lose weight or maintain their current weight. They do not want to search for information on their own and are ready to trust experienced instructors.',
    ...
    'sections' => [
      [
        'title' => 'QUESTIONNAIRE',
        'strong' => 'An individual nutrition and training plan is formed on the basis of a questionnaire',
      ...
      [
        'title' => 'PROGRESS',
        'strong' => 'The user’s account reflects all the data of the participant',
