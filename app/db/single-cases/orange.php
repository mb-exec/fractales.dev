<?php
  $orange = [
    'title' => 'ORANGE<br>beauty salon chain',
    'tag' => 'Services', 
    ...
    // секция about
    'about' => 'Orange is working offline business with 10 beauty salons. The value of the service is a friendly atmosphere, long—term relationships with customers, individual approach.<br><br>
    ...
    'sections' => [
      [
        ...
        'strong' => 'Emphasized the uniqueness of the service',
      ...
      [
        'title' => 'SERVICE PAGE',
        'strong' => 'Detailed description of the service',
      ...
      [
        'title' => 'MASTERS',
        'strong' => 'Focus on the ease of choice',
      ...
      [
        'title' => 'SERVICE CARD',
        'strong' => 'Description and advantages',
      ...
      [
        'title' => 'SALONS SECTION',
        'strong' => 'Convenience of choice',
